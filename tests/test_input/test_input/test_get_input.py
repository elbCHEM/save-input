import pytest
from save_input.input import get_input, TooManyQuestionAsked, _MAX_QUESTIONS_ASKED
...
def test_max_question_hard_limit(monkeypatch) -> None:
    ...
    with pytest.raises(TooManyQuestionAsked) as error:
        ...
        assert error.question_asked == _MAX_QUESTIONS_ASKED
